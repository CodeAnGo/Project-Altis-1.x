...
NametagFonts = (
    ...
    'phase_3/models/fonts/Friends.ttf'
)
NametagFontNames = (
    'Basic',
    'Plain',
...
GlobalStreetNames = {20000: ('to', 'on', 'Tutorial Terrace'),
 ...
 19000: ('to the', 'in the', 'Looney Labs')}
...
QuestDialog_2910 = {QUEST:  'Back so soon?\x07I need one more favor.\x07I need some flour.\x07Please ask _toNpcName_ if I may get some._where_'}
...
NPCFriendPageDeleteConfirmation = 'Are you sure you want to delete this SOS card?'
...
ForcedLeaveMintAckMsg = 'The Mint Supervisor was defeated before you could reach him. You did not recover any Cogbucks.'
HeadingToFactoryTitle = '%s'
ForemanConfrontedMsg = '%s is battling the ' + Foreman + '!'
MintBossConfrontedMsg = '%s is battling the Mint Supervisor!'
StageBossConfrontedMsg = '%s is battling the District Attorney!'
stageToonEnterElevator = '%s \nhas entered the elevator'
ForcedLeaveStageAckMsg = 'The Lawbot District Attorney was defeated before you could reach him. You did not recover any Jury Notices.'
...
NPCToonNames = {20000: 'Tutorial Tom',
 ...
 7008: 'Ima Cagedtoon',
 7009: 'Jimmy Thelock',
91913: 'unused', # 9/19/13 = Closing of Toontown, just a random number to start with so we don't take up other IDs
91914: 'unused',
91915: 'unused',
91916: 'unused'}
...
TipDict = {TIP_NONE: ('',),
 ...
 TIP_STREET: ('There are five types of Cogs: Lawbots, Cashbots, Sellbots, Bossbots, and Boardbots.',
              ...
              'In Lawbot Field Offices, be sure to refuel your propeller often!',
              'In Lawbot Field Offices, pick up feathers guarded by Legal Eagles for a laff boost.',
              'In Lawbot Field Offices, pick up red tape to protect yourself from Legal Eagles.',
              'In Lawbot Field Offices, watch out for Legal Eagles! They will take away some of your laff.',
              'In Lawbot Field Offices, fly over fans with streamers to get a boost!',
              'In Lawbot Field Offices, be sure to avoid whirlwinds. They will lock you in place, wasting precious fuel.',
              'In Sellbot Field Offices, pick up jokes dropped by Cogs to get a laff boost.',
              'In Sellbot Field Offices, falling cabinets will pop your water balloon.',
              'In Sellbot Field Offices, Mover & Shaker cogs take two hits to defeat.',
 ...
 TIP_MINIGAME: ('After you fill up your jellybean jar, any Jellybeans you get from Trolley Games automatically spill over into your bank.',
                'You can use the arrow keys instead of the mouse in the "Match Kion" Trolley Game.',
                ...
                'A perfect game of Match Kion will double your points.',
